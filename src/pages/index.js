...
export default function Home() {
  ...
  return (
    ...
    <Head>
        ...
        <meta name="description" content="A food delivery site that you can order groceries and hot dishes." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/FoodBase2.ico" />

        <meta property="og:type" content="website" />
        <meta property="og:title" content="FoodBase - Groceries and Food Delivery"/>
        ...
        <meta property="twitter:url" content="https://foodbase-tr.vercel.app/"/>
        <meta property="twitter:title" content="FoodBase"/>
        <meta property="twitter:description" content="A food delivery site that you can order groceries and hot dishes."/>
